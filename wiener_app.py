...
# # --- FIXED Plotting Helper ---
# def apply_theme_to_plot(fig, ax, theme):
#     fig.patch.set_facecolor(theme['bg'])
    
#     # Correctly handle different types of 'ax' inputs
#     if hasattr(ax, 'flat'):  # Numpy array (from subplots with multiple axes)
#         axes = ax.flat
#     elif isinstance(ax, (list, tuple)):  # List or Tuple of axes
#         axes = ax
...
#         # Correctly passing list of axes here
